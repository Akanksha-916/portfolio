        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start justify-center pr-0 lg:pr-6">
            ...
            <div className="max-w-xl mb-8 sm:mb-10">
              <h1 className="text-4xl sm:text-6xl lg:text-[4.75rem] xl:text-[5.25rem] font-serif text-white tracking-tight leading-[1.06] sm:leading-[1.02]">
          ...
          {/* Right Column: Editorial Portrait Artwork (~40-42% width) */}
          <div className="lg:col-span-5 flex justify-center lg:justify-end relative">
            <div className="relative w-full max-w-[340px] sm:max-w-[380px] lg:max-w-[420px] select-none">
              <img
                src="/images/akanksha-editorial.png"
                alt="Akanksha — Computer Science Student & Developer"
                className="w-full h-auto object-contain drop-shadow-2xl transition-transform duration-700 ease-out hover:scale-[1.02]"
                loading="eager"
              />
            </div>
          </div>
